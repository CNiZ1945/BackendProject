...
public class MovieServiceImpl implements MovieService {
    ...
    //영화 정보 추가
    private void addMovieActors(MovieEntity movieEntity, List<Integer> actorIds) {
        if (actorIds != null) {
    ...
    //감독 정보 추가
    private void addMovieDirectors(MovieEntity movieEntity, List<Integer> directorIds) {
        if (directorIds != null) {
