...
@Setter
@NoArgsConstructor
public class AdminMovieDetailResponseDTO {
    ...
    @Builder
    public AdminMovieDetailResponseDTO(Long movieId, String movieTitle, int runTime, Integer openYear,
    ...
    public static AdminMovieDetailResponseDTO fromEntity(MovieEntity movie) {
        return AdminMovieDetailResponseDTO.builder()
                ...
                .trailerUrls(movie.getTrailer().stream()
                        .map(MovieTrailersEntity::getTrailerUrls)
                        .collect(Collectors.toList()))
